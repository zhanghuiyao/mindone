...
def prepare_parallel_data(hidden_states, encoder_hidden_states, attention_mask, encoder_attention_mask, use_image_num):
    ...
    if use_image_num == 0:
        ...
        video_encoder_states, image_encoder_states = encoder_hidden_states[:, :-use_image_num], \
                                                     encoder_hidden_states[:, -use_image_num:]
        video_encoder_attention_mask, image_encoder_attention_mask = encoder_attention_mask[:, :-use_image_num], \
