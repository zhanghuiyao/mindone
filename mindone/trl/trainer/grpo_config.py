...
from mindone.transformers.training_args import TrainingArguments, _VALID_DICT_FIELDS
...
class GRPOConfig(TrainingArguments):
    ...
    Parameters:
        ...
        wandb_log_unique_prompts (`bool`, *optional*, defaults to `False`):
            ...
            prompts are logged.
    """
    from mindone.transformers.training_args import _VALID_DICT_FIELDS
    _VALID_DICT_FIELDS.append("model_init_kwargs")
    # _VALID_DICT_FIELDS = TrainingArguments._VALID_DICT_FIELDS + ["model_init_kwargs"]  #TODO: support newest transformers >= 4.50.3
